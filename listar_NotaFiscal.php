        ...
        <header>
            ...
            <main class="pb-12">
                ...
                <div class="relative overflow-x-auto sm:rounded-lg px-5 md:px-40 pt-20">
                    <h5 class="mb-2 text-3xl font-bold tracking-tight text-rose-700 text-left">Consulta de Notas Fiscais</h5>
                    <table class="w-full text-base text-center rtl:text-right text-gray-900 p-5 border border-rose-700">
                        ...
                        <tbody class="bg-white divide-y divide-rose-800">  
                            <?php foreach ($NotaFiscal as $notaFiscal): ?>
                                <tr>
                                    <td class="px-6 py-4 bg-rose-200" data-label="Código da Nota Fiscal">
                                        <?= $notaFiscal['CodigoNotaFiscal']; ?>
                                    </td>
                                    <td class="px-6 py-4" data-label="Número da Nota Fiscal">
                                        <?= $notaFiscal['NumeroNotaFiscal']; ?>
                                    </td>
                                    <td class="px-6 py-4 bg-rose-200" data-label="Código do Cliente">
                                        <?= $notaFiscal['CodigoCliente']; ?>
                                    </td>
                                    <td class="px-6 py-4" data-label="Código do Vendedor">
                                        <?= $notaFiscal['CodigoVendedor']; ?>
                                    </td>
                                    <td class="px-6 py-4 bg-rose-200" data-label="Data de Emissão">
