        ...
        <div class="container">
            <div class="flex justify-center">
                    <div class="section-heading">
                        ...
                        ?>
                        <h2 class="text-lg font-bold mb-4 text-rose-700">Listagem de Regiões</h2>
                        <table class="w-full bg-white border-2 border-rose-700">
                            <thead>
                                <tr class="bg-rose-700 text-white">
                                    <th class="px-4 py-2">Código da Região</th>
                            ...
                            <tbody>
                                <?php foreach ($regioes as $regiao): ?>
                                    <tr>
                                        <td class="border-t border-rose-700 px-4 py-2"><?= $regiao['CodigoRegiao']; ?></td>
                                        <td class="border-t border-rose-700 px-4 py-2"><?= $regiao['NomeRegiao']; ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
