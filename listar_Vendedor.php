            ...
            <main class="pb-12">
                <div id="wrapper">
                    ...
                    <div class="relative overflow-x-auto sm:rounded-lg px-5 md:px-40 pt-20">
                        <h5 class="mb-2 text-3xl font-bold tracking-tight text-rose-700 text-left">Consulta de Vendedores</h5>
                        <table class="w-full text-base text-center rtl:text-right text-gray-900 p-5 border border-rose-700">
                            ...
                            <tbody class="bg-white divide-y divide-rose-800">
                                <?php foreach ($vendedores as $vendedor): ?>
                                    <tr>
                                        <td class="px-6 py-4 bg-rose-200" data-label="Código do Vendedor">
                                            <?= $vendedor['CodigoVendedor']; ?>
                                        </td>
                                        <td class="px-6 py-4" data-label="Código da Região">
                                            <?= $vendedor['CodigoRegiao']; ?>
                                        </td>
                                        <td class="px-6 py-4 bg-rose-200" data-label="Nome do Vendedor">
                                            <?= $vendedor['NomeVendedor']; ?>
                                        </td>
                                        <td class="px-6 py-4" data-label="Rg do Vendedor">
                                            <?= $vendedor['RGVendedor']; ?>
                                        </td>
                                        <td class="px-6 py-4 bg-rose-200" data-label="Data de Nascimento">
                                            <?= $vendedor['DataNascimento']; ?>
                                        </td>
                                        <td class="px-6 py-4" data-label="Telefone do Vendedor">
