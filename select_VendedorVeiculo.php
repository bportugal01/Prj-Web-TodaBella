    ...
    <div class="container">
        <div class="flex justify-center">
                <div class="section-heading">
                    ...
                    $vendedoresVeiculo = VeiculoDAO::listarVendedoresVeiculosUltimoMes();
                    ?>
                    <h2 class="text-lg font-bold mb-4 text-rose-700">Listagem de Vendedores e Veículos</h2>
                    <table class="w-full bg-white border-2 border-rose-700">
                        <thead>
                            <tr class="bg-rose-700 text-white">
                                <th class="px-4 py-2">Código do Vendedor</th>
                                <th class="px-4 py-2">Nome do Vendedor</th>
                                <th class="px-4 py-2">Código do Veículo</th>
                                <th class="px-4 py-2">Placa do Veículo</th>
                                <th class="px-4 py-2">Tipo do Veículo</th>
                                <th class="px-4 py-2">Modelo do Veículo</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($vendedoresVeiculo as $vendedorVeiculo): ?>
                                <tr>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $vendedorVeiculo['CodigoVendedor']; ?></td>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $vendedorVeiculo['NomeVendedor']; ?></td>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $vendedorVeiculo['CodigoVeiculo']; ?></td>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $vendedorVeiculo['PlacaVeiculo']; ?></td>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $vendedorVeiculo['TipoVeiculo']; ?></td>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $vendedorVeiculo['ModeloVeiculo']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
