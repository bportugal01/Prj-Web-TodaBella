        ...
        <main>
            <div class="flex justify-center py-24">
                <div class="block max-w-3xl p-6 bg-white border border-gray-200 rounded-lg shadow">
                    <h5 class="mb-2 text-4xl font-bold tracking-tight text-rose-700 text-center px-12 pb-5">Editar Cliente</h5>
                            ...
                            <div>
                                <div class="mb-5">
                                    <fieldset>
                                        ...
                                        <input type="text" id="enderecoCliente" name="enderecoCliente" placeholder="Digite o endereço" class="bg-gray-100 border-2 border-rose-700 text-gray-700 placeholder-rose-700 text-base focus:ring-rose-800 focus:border-rose-800 block w-full p-2.5" 
                            ...
                            <div>
                                <div class="mb-5">
                                    <fieldset>
                                        ...
                                        <input type="text" name="numeroCliente" id="numeroCliente" placeholder="Digite o número" class="bg-gray-100 border-2 border-rose-700 text-gray-700 placeholder-rose-700 text-base focus:ring-rose-800 focus:border-rose-800 block w-full p-2.5" required />
                                    </fieldset>    
                                </div>
                            </div>
                        </div>
