...
<head>
    ...
    <title>Produtos - Não vendidos</title>
        ...
        <div class="flex justify-center">
            <div class="p-4">
                <div class="section-heading">
                    ...
                    $produtosNao = ProdutoDAO::listarProdutosNaoVendidos();
                    ?>
                    <h2 class="text-lg font-bold mb-4 text-rose-700">Listagem de Produtos Não Vendidos</h2>
                    ...
                    <table class="w-full bg-white border-2 border-rose-700">
                        <thead>
                            <tr class="bg-rose-700 text-white">
                                ...
                                <th class="px-4 py-2">Preço do Produto</th>
                                <th class="px-4 py-2">Quantidade do Produto</th>
                                <th class="px-4 py-2">Descrição do Produto</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($produtosNao as $produtoNao): ?>
                                <tr>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $produtoNao['CodigoProduto']; ?></td>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $produtoNao['NomeProduto']; ?></td>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $produtoNao['PrecoUnitario']; ?></td>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $produtoNao['QuantidadeEstoque']; ?></td>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $produtoNao['SituacaoProduto']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
