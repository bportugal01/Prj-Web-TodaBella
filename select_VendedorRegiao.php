        ...
        <div class="flex justify-center">
            <div class="p-4">
                <div class="section-heading">
                    ...
                    $vendedoreRegiao = RegiaoDAO::listarVendedoresPorRegiao();
                    ?>
                    <h2 class="text-lg font-bold mb-4 text-rose-700">Listagem de Vendedores e Regiões</h2>
                    <table class="w-full bg-white border-2 border-rose-700">
                        <thead>
                            <tr class="bg-rose-700 text-white">
                                <th class="px-4 py-2">Nome da Região</th>
                        ...
                        <tbody>
                            <?php foreach ($vendedoreRegiao as $vendedorRegiao): ?>
                                <tr>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $vendedorRegiao['NomeRegiao']; ?></td>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $vendedorRegiao['NomeVendedor']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
