...
<head>
    ...
    <title>Pontos Estratégicos por Regiões</title>
        ...
        <div class="flex justify-center ">
            <div class="p-4">
                <div class="section-heading">
                    ...
                    <h2 class="text-lg font-bold mb-4 text-rose-700">Lista de pontos estratégicos por região</h2>

                    <table class="w-full bg-white border-2 border-rose-700">
                        <thead>
                            <tr class="bg-rose-700 text-white">
                                <th class="px-4 py-2">Região</th>
                                <th class="px-4 py-2">Ponto Estratégico</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($pontos as $ponto): ?>
                                <tr>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $ponto['NomeRegiao'] ?></td>
                                    <td class="border-t border-rose-700 px-4 py-2"><?= $ponto['NomePonto'] ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
